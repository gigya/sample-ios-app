...
// Changelog 2.15.6 - changed viewController assignment from GSSDK constructor to methods that use the viewController, added setSession from sendRequest response.
...
#endif
#define	GSAPI_SDK_VERSION_STRING	@"iOS_2.15.6"

#define GSAPI_NET_SELECT_URL @"gsapi://network_selected/"
#define GSAPI_UI_URL @"http://socialize.%@/gs/mobile/loginui.aspx"
